...
send(msg.chat_id_, msg.id_, 1,"👤┇رتبتك في البوت >> "..t.."", 1, 'md')
end
---------------------------------
...
if (text and text == "مسح محظورين الكروب" and (is_creator(msg) or is_creatorbasic(msg))) then
...
----------------------------------------------------------------------------------------------
if text:match('^تنظيف (%d+)$') and (is_mod(msg) or is_creatorbasic(msg)) then
...
--------------------------------
if (text and text == "مسح صلاحيه" and (is_creator(msg) or is_creatorbasic(msg))) then 
...
if (text and text == "مسح الصلاحيات" and (is_creator(msg) or is_creatorbasic(msg))) then 
...
if (text and text == "الصلاحيات" and (is_creator(msg) or is_creatorbasic(msg))) then 
local list = database:smembers('tshake:'..bot_id..'tshakenwe:slahea'..msg.chat_id_)
if #list == 0 then
