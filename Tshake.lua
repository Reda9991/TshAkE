...
function fwwdmsg(riida,storm,sorc)  
...
send(msg.chat_id_, msg.id_, 1,'*🔖┇ عدد المجموعات الان ↫ ( '..#group..' )*'..storm..''..riida..'\n*📌┇ الان عدد المجموعات الحقيقي ↫ ( '..sendok..' ) مجموعات*\n', 1, 'md')   
end
end
end,nil)
end
...
sendContact(msg.chat_id_, msg.id_, 0, 1, nil, (nkeko or 9647711049891), (nakeko or " Ridha"), "", bot_id)
end
end
for k,v in pairs(sudo_users) do
...
riida = '🔵┇اول واحد يكتب معنئ السمايل » {'..name..'}'
send(msg.chat_id_, msg.id_, 1,riida, 1, 'md')
end
------------------------------------------------------------------------
...
riida = "*📬┇ عذرآ لا يمكنك تخمين عدد اكبر من ال { 20 } خمن رقم ما بين ال{ 1 و 20 } *\n"
send(msg.chat_id_, msg.id_, 1,riida, 1, 'md')
return false  end 
...
riida = '*🔖┇ مبروك فزت ويانه وخمنت الرقم الصحيح\n🚸┇ تم اضافة { 5 } من النقاط *\n'
send(msg.chat_id_, msg.id_, 1,riida, 1, 'md')
...
riida = "*📬┇ عذرا لا يوجد سواء { 6 } اختيارات فقط ارسل اختيارك مره اخرى*\n"
send(msg.chat_id_, msg.id_, 1,riida, 1, 'md')
return false  end 
...
riida = '*📮┇ مبروك فزت وطلعت المحيبس بل ايد رقم { '..NUM..' }\n🎊┇ لقد حصلت على { 3 }من نقاط يمكنك استبدالهن برسائل *'
send(msg.chat_id_, msg.id_, 1,riida, 1, 'md')
...
riida = '*💎¦ ليس لديك مجوهرات \n📬¦ للحصول على مجوهرات ارسل الاسرع وابدأ اللعب*\n'
send(msg.chat_id_, msg.id_, 1,riida, 1, 'md')
else
riida = '*💎¦ عدد مجوهراتك الحاليه  ('..(database:get('tshake:'..bot_id..'add:num'..msg.chat_id_..msg.sender_user_id_))..')*'
riida1 = '*💎¦ مجموع مجوهراتك  ('..(database:get('tshake:'..bot_id..'add:numall'..msg.chat_id_..msg.sender_user_id_))..')*'

send(msg.chat_id_, msg.id_, 1,''..riida..'\n'..riida1..'', 1, 'md')
end
end
...
riida = (database:get('tshake:'..bot_id..'add:num'..msg.chat_id_..msg.sender_user_id_) * tonumber(database:get('tshake:'..bot_id..'gamepoint' .. msg.chat_id_)or 50))
database:incrby('tshake:'..bot_id..'nummsg'..msg.chat_id_..msg.sender_user_id_,riida)
database:del('tshake:'..bot_id..'add:num'..msg.chat_id_..msg.sender_user_id_)
riida = tonumber((database:get('tshake:'..bot_id..'gamepoint' .. msg.chat_id_) or 50))
send(msg.chat_id_, msg.id_, 1,'💎¦ تم بيع جواهرك كل مجوهره تساوي '..riida..' رساله', 'md')
end
end
...
if (text and text == 'تغير امر م5') or (text and text == 'تغير امر اوامر التقييد') then
send(msg.chat_id_, msg.id_, 1, '📥┇الان يمكنك ارسال الكليشه ليتم حفظها', 1, 'html')
