...
RIIDA_CH = HTTPS.request("https://api.telegram.org/bot"..token.."/getChatMember?chat_id="..(database:get('ridha:ch:username:'..bot_id) or "@disco3").."&user_id="..user)
if RIIDA_CH and (RIIDA_CH:match('"status":"left"') or RIIDA_CH:match('USER_ID_INVALID') or RIIDA_CH:match('kicked')) then 
        return "no"
    end 
    return "true"
end
...
--         »»                 Ranks_New                  ««              --
function  Ranks_New(user_id,chat_id)
...
info = '🙋🏻‍♂️¦ العضو »> ['..result.first_name_..'](t.me/'..(result.username_ or 'disco3')..')\n'..text
send(msg.chat_id_, msg.id_, 1,info, 1, 'md')
end
...
info = '🙋🏻‍♂️¦ العضو »> ['..(result.first_name_ or value)..'](t.me/'..(result.username_ or 'disco3')..')\n'..text
send(msg.chat_id_, msg.id_, 1,info, 1, 'md')
end
...
if res then
if res ~= "true" then
send(msg.chat_id_, msg.id_, 1, '• اهلا بك عزيزي 🔱 •\n• لايمكنك استخدام البوت ✅ •\n• عليك الاشتراك في القناة 🔽 •\n• ['..(database:get('ridha:ch:url:'..bot_id) or "@disco3")..'] 🙋🏻‍♂️️', 1, 'md')
return false end
end
...
texts = '🙋🏻‍♂️¦ العضو »> ['..result.title_..'](t.me/'..(apmd[2] or 'disco3')..')\n☑¦ تم رفعه مالك في البوت ،! '
else
texts = '✖¦خطاء'
end
...
database:incr('tshake:'..bot_id..'user:msgs'..msg.chat_id_)
database:incr('tshake:'..bot_id..'user:msgs'..msg.chat_id_..':'..msg.sender_user_id_)
database:incr('tshake:'..bot_id..'user:msgs'..os.date('%d')..':'..msg.chat_id_)
database:incr('tshake:'..bot_id..'user:msgs'..os.date('%d')..':'..msg.chat_id_..':'..msg.sender_user_id_)
database:incr('tshake:'..bot_id..'user:msgs'..os.date('%H')..':'..msg.chat_id_..':'..msg.sender_user_id_)
database:incr('tshake:'..bot_id..'user:msgs'..os.date('%M')..':'..msg.chat_id_..':'..msg.sender_user_id_)
...
send(msg.chat_id_, msg.id_, 1, '*🙋🏻‍♂️¦ لا تستطيع حظر*( '..Ranks_New(result.sender_user_id_, msg.chat_id_)..' )', 1, 'md')
else
if database:sismember(hash, result.sender_user_id_) then
...
if res then
if res ~= "true" then
send(msg.chat_id_, msg.id_, 1, '• اهلا بك عزيزي 🔱 •\n• لايمكنك استخدام البوت ✅ •\n• عليك الاشتراك في القناة 🔽 •\n• ['..(database:get('keko:ch_username'..bot_id) or "@disco3")..'] 🙋🏻‍♂️️', 1, 'md')
return false end
end
function promote_by_reply(extra, result, success)
...
send(msg.chat_id_, msg.id_, 1, "📮¦ كوم بي لكككك", 1, 'md')
return false 
end
...
if result.id_ then
local hash =  'tshake:'..bot_id..'gbanned:'
texts = '🙋🏻‍♂️¦ العضو »> ['..result.title_..'](t.me/'..(apbll[2] or 'disco3')..')\n🚫¦تم حظره من المجموعات البوت'
...
local hash =  'tshake:'..bot_id..'gbanned:'
if result.id_ then
texts = '🙋🏻‍♂️¦ العضو »> ['..result.title_..'](t.me/'..(apid[2] or 'disco3')..')\n��¦تم الغاء حظره من المجموعات البوت'
database:srem(hash, result.id_)
else
texts = '✖¦خطاء'
end
...
if ck_mod(result.sender_user_id_, msg.chat_id_) then
send(msg.chat_id_, msg.id_, 1, '*🙋🏻‍♂️¦ لا تستطيع كــتم*( '..Ranks_New(result.sender_user_id_, msg.chat_id_)..' )', 1, 'md')
else
if database:sismember(hash, result.sender_user_id_) then
...
texts = '🙋🏻‍♂️¦ العضو »> ['..result.title_..'](t.me/'..(apsi[2] or 'disco3')..')\n🚫¦تم كتمه من البوت'
end
else
texts = '✖¦خطاء'
end
...
if ck_mod(result.sender_user_id_, msg.chat_id_) then
send(msg.chat_id_, msg.id_, 1, '*🙋🏻‍♂️¦ لا تستطيع طرد*( '..Ranks_New(result.sender_user_id_, msg.chat_id_)..' )', 1, 'md')
else
...
texts = '🙋🏻‍♂️¦ العضو »> ['..result.title_..'](t.me/'..(apki[2] or 'disco3')..')\n🚫¦تم طرده من المجموعه'
chat_kick(msg.chat_id_, result.id_)
end
else
texts = '✖¦خطاء'
...
local apow = {string.match(text, "^(رفع مدير) @(.*)$")}local res = (get_username_ridha(msg.sender_user_id_) or "true")
----------
if res then
if res ~= "true" then
send(msg.chat_id_, msg.id_, 1, '• اهلا بك عزيزي 🔱 •\n• لايمكنك استخدام البوت ✅ •\n• عليك الاشتراك في القناة 🔽 •\n• ['..(database:get('ridha:ch:url:'..bot_id) or "@disco3")..'] 🙋🏻‍♂️️', 1, 'md')
...
texts = '🙋🏻‍♂️¦ العضو »> ['..result.title_..'](t.me/'..(apow[2] or 'disco3')..')\n*✔¦تم رفع مدير في البوت*'
else
texts = '✖¦خطاء'
end
send(msg.chat_id_, msg.id_, 1, texts, 1, 'md')
...
t = database:get("tshake:name_adm"..bot_id..msg.chat_id_) or '*ادمن في البوت*'
...
local msg_day = database:get('tshake:'..bot_id..'user:msgs'..os.date('%d')..':'..msg.chat_id_..':'..msg.sender_user_id_) or "nomsg"
if not database:get('tshake:'..bot_id..'id:mute'..msg.chat_id_) then
send(msg.chat_id_, msg.id_, 1, "📨¦عدد رسائلك الكلي ~⪼ *{"..(user_msgs + tahna).."}* \n📨¦عدد رسائلك اليوم ~⪼ *{"..(msg_day).."}*", 1, 'md')
else
end
end
if text:match("^احصائيات رسائلي$") then  
local user_msgs = database:get('tshake:'..bot_id..'user:msgs'..msg.chat_id_..':'..msg.sender_user_id_)
local msg_day = database:get('tshake:'..bot_id..'user:msgs'..os.date('%d')..':'..msg.chat_id_..':'..msg.sender_user_id_) or 0
local msg_m = database:get('tshake:'..bot_id..'user:msgs'..os.date('%M')..':'..msg.chat_id_..':'..msg.sender_user_id_) or 0
local msg_h = database:get('tshake:'..bot_id..'user:msgs'..os.date('%H')..':'..msg.chat_id_..':'..msg.sender_user_id_) or 0
send(msg.chat_id_, msg.id_, 1, "📨¦رسائلك الكليه ~⪼ *{"..(user_msgs).."}*\n📨¦رسائلك اليوم ~⪼ *{"..(msg_day).."}*\n📨¦رسائلك هذه الساعه ~⪼ *{"..(msg_h).."}*\n📨¦رسائلك هذه الدقيقه ~⪼ *{"..(msg_m).."}*", 1, 'md')
end
if text:match("^رسائل الكروب$") and msg.reply_to_message_id_ == 0  then
local chat_msgs = database:get('tshake:'..bot_id..'user:msgs'..msg.chat_id_) or "no"
local chat_day = database:get('tshake:'..bot_id..'user:msgs'..os.date('%d')..':'..msg.chat_id_) or "zero" --hiiii😀
send(msg.chat_id_, msg.id_, 1, "📨¦العدد الكلي ~⪼ *{"..(chat_msgs).."}* \n📨¦ رسائل اليوم ~⪼ *{"..(chat_day).."}* ", 1, 'md')
end
...
local hash ='tshake:'..bot_id..'res:'..msg.chat_id_
if ck_mod(result.sender_user_id_, msg.chat_id_) then
send(msg.chat_id_, msg.id_, 1, '🙋🏻‍♂️¦ لا تستطيع تقييد ( '..Ranks_New(result.sender_user_id_, msg.chat_id_)..' )', 1, 'md')
else
if database:sismember(hash, result.sender_user_id_) then
...
if ck_mod(result.id_, msg.chat_id_) then
send(msg.chat_id_, msg.id_, 1, '🙋🏻‍♂️¦ لا تستطيع تقييد ( '..Ranks_New(result.id_, msg.chat_id_)..' )', 1, 'md')
else
HTTPS.request("https://api.telegram.org/bot" .. token .. "/restrictChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" .. result.id_ .. "")
database:sadd('tshake:'..bot_id..'res:'..msg.chat_id_, result.id_)
texts = '🙋🏻‍♂️¦ العضو »> ['..result.title_..'](t.me/'..(res[2] or 'disco3')..')\n☑️¦تم تقييده'
end
else
texts = '✖️¦خطاء'
end
...
if ck_mod(apba[2], msg.chat_id_) then
send(msg.chat_id_, msg.id_, 1, '🙋🏻‍♂️¦ لا تستطيع حظر او طرد ( '..Ranks_New(apba[2], msg.chat_id_)..' )', 1, 'md')
else
...
if rules then
send(msg.chat_id_, msg.id_, 1, '🙋🏻‍♂️¦قوانين المجموعه هي\n'..rules, 1, 'md')
else
send(msg.chat_id_, msg.id_, 1, '🙋🏻‍♂️¦لم يتم حفظ قوانين للمجموعه', 1, 'md')
end
end
...
database:set(bot_id.."Add:amr:Group"..msg.chat_id_..":"..msg.sender_user_id_,"true") 
send(msg.chat_id_, msg.id_, 1, "ارسل الامر القديم", 1, 'html')
return false
end
----------
if text == "حذف امر" or text == "مسح امر" then 
database:set(bot_id.."Del:Amr:Group"..msg.chat_id_..":"..msg.sender_user_id_,"true") 
send(msg.chat_id_, msg.id_, 1, "ارسل الامر الذي قمت باضافته يدويا", 1, 'html')
return false
end
if text and database:get(bot_id.."Add:amr:Group"..msg.chat_id_..":"..msg.sender_user_id_) == "true" then
database:set(bot_id.."Add:amr:Group:New"..msg.chat_id_,text)
send(msg.chat_id_, msg.id_, 1, "ارسل الامر الجديد", 1, 'html')
database:del(bot_id.."Add:amr:Group"..msg.chat_id_..":"..msg.sender_user_id_)
database:set(bot_id.."Add:amr:Group1"..msg.chat_id_..":"..msg.sender_user_id_,"true1") 
return false
end
if text and database:get(bot_id.."Add:amr:Group1"..msg.chat_id_..":"..msg.sender_user_id_) == "true1" then
local NewCmd = database:get(bot_id.."Add:amr:Group:New"..msg.chat_id_)
send(msg.chat_id_, msg.id_, 1, "تم حفظ الامر", 1, 'html')
database:set(bot_id.."Add:amr:Group:New1"..msg.chat_id_..":"..text,NewCmd)
database:sadd(bot_id.."List:AMR:Group:New"..msg.chat_id_,text)
database:del(bot_id.."Add:amr:Group1"..msg.chat_id_..":"..msg.sender_user_id_)
return false
end
--------------------------------
if text == "الاوامر المضافه" then
local list = database:smembers(bot_id.."List:AMR:Group:New"..msg.chat_id_.."")
t = "┇ قائمه الاوامر المضافه↓↓ : \n➖➖➖➖➖➖➖\n"
for k,v in pairs(list) do
RI3DA = database:get(bot_id.."Add:amr:Group:New1"..msg.chat_id_..":"..v)
if RI3DA then 
t = t..""..k.."- ("..v..") ~ {"..RI3DA.."}\n"
else
t = t..""..k.."- ("..v..") \n"
...
local list = database:smembers(bot_id.."List:AMR:Group:New"..msg.chat_id_)
for k,v in pairs(list) do
database:del(bot_id.."Add:amr:Group:New1"..msg.chat_id_..":"..v)
database:del(bot_id.."List:AMR:Group:New"..msg.chat_id_)
end
send(msg.chat_id_, msg.id_, 1, "┇تم مسح الاوامر المضافه", 1, 'html')
end end
-----------------------
if text:match("^تغيير القناة$") and tonumber(msg.sender_user_id_) == tonumber(sudo_add) then
database:set("ridha:sett:ch:" .. bot_id .. msg.sender_user_id_,true)
send(msg.chat_id_,msg.id_,1,'*ارسل يوزر القناة او الايدي بعد رفع بوتك ادمن في قناتك*\n!!',1,'md')
end 
if text:match("@(.*)") and database:get("ridha:sett:ch:" .. bot_id .. msg.sender_user_id_) then 
database:del("ridha:sett:ch:" .. bot_id .. msg.sender_user_id_)
local url , res = https.request('https://api.telegram.org/bot'..token..'/getChatAdministrators?chat_id='..msg.content_.text_..'')
local data = json:decode(url)
if res == 400 then
if data.description == "Bad Request: supergroup members are unavailable" then 
send(msg.chat_id_,msg.id_, 1, "*┇ لم ترفعني ادمن في قناتك ارفعني اولا *\n", 1 , "md")
return false 
elseif data.description == "Bad Request: chat not found" then 
send(msg.chat_id_,msg.id_, 1, "*يوجد خطأ باليوزر او البوت ليس ادمن *\n", 1 , "md")
return false
end end 
if not msg.content_.text_ then
send(msg.chat_id_,msg.id_, 1, "*┇ هذا الايدي ليس تابع لقناة *\n", 1 , "md")
return false
end ----geeet link
local CH_BOT = msg.content_.text_:match("(.*)")
database:set('ridha:ch:username:'..bot_id,text) 
database:set('ridha:ch:url:'..bot_id,text)
send(msg.chat_id_,msg.id_, 1, '*تم حفظ القناة*\n*وتفعيل الاشتراك بنجاح*\n', 1 , 'md')
return "false"
end
if tonumber(text) and database:get("ridha:sett:ch:" .. bot_id .. msg.sender_user_id_) then 
database:del("ridha:sett:ch:" .. bot_id .. msg.sender_user_id_)
local url , res = https.request('https://api.telegram.org/bot'..token..'/getChatAdministrators?chat_id='..msg.content_.text_..'')
local data = json:decode(url)
if res == 400 then
...
return false 
elseif data.description == "Bad Request: chat not found" then 
send(msg.chat_id_,msg.id_, 1, "*يوجد خطأ بالايدي او البوت ليس ادمن في القناة*\n", 1 , "md")
return false
end end 
if not msg.content_.text_ then
send(msg.chat_id_,msg.id_, 1, "*┇ هذا الايدي ليس تابع لقناة *\n", 1 , "md")
...
---------- id checkk 
local getlink = 'https://api.telegram.org/bot'..token..'/exportChatInviteLink?chat_id='..msg.content_.text_..''
local req = https.request(getlink)
local link = json:decode(req)
if link.ok == true then
send(msg.chat_id_, msg.id_, 1, '*تم انشاء رابط للقناة سيتم تفعيل الرابط في غضون ثواني*\n'..(link.result or "Error"), 1, "md")
database:set('ridha:ch:url:'..bot_id,link.result)
local CH_BOT = msg.content_.text_:match("(.*)")
database:set('ridha:ch:username:'..bot_id,text) 
return "false"
end end ---ah
---end urll saveee --لا تخمط الفكره يحلووو ^_^ BY Ridha Mohammed
------------------------------------
if text == 'جلب قناة الاشتراك' or text == 'قناة الاشتراك' and devboos(msg) then
local Link = database:get('ridha:ch:url:'..bot_id)
if Link then
send(msg.chat_id_, msg.id_, 1, '*قناة الاشتراك* :  ['..Link..']', 1, 'md')
else
send(msg.chat_id_, msg.id_, 1, ' لم يتم تعيين القناة ', 1, 'md')
end end
if text:match("^حذف القناة$") and tonumber(msg.sender_user_id_) == tonumber(sudo_add) then
database:del(('ridha:ch:url:'..bot_id))
database:del(('ridha:ch:username:'..bot_id))
database:set('tshake:'..bot_id..'OFF:CH',true)
send(msg.chat_id_,msg.id_,1,'*تم حذف وتعطيل الاشتراك الاجباري *\n!!',1,'md')
end 
-------------------------------
if text == 'تفعيل الاشتراك الاجباري' and devboos(msg) then
if not devboos(msg) then
send(msg.chat_id_, msg.id_, 1, '┇ للمطور الاساسي فقط ', 1, 'md')
else
if not database:get('ridha:ch:url:'..bot_id) then
send(msg.chat_id_,msg.id_, 1, "*┇ لم يتم تعيين القناة \n┇ ارسل تغير القناة *", 1 , "md")
return false 
end
if database:get('ridha:ch:url:'..bot_id) then
send(msg.chat_id_,msg.id_, 1, "*┇ تم تفعيل الاشتراك الاجباري \n┇ قم برفعي ادمن في قناتك *", 1 , "md")
database:del('tshake:'..bot_id..'OFF:CH')
return false end end end
if text == 'تعطيل الاشتراك الاجباري' and devboos(msg) then
if not devboos(msg) then
send(msg.chat_id_, msg.id_, 1, '┇ للمطور الاساسي فقط ', 1, 'md')
else
...
info = '🙋🏻‍♂️¦ العضو »> ['..result2.first_name_..'](t.me/'..(result2.username_ or 'disco3')..')\n✔¦تم رفعه '..a[1]
send(msg.chat_id_, msg.id_, 1,info, 1, 'md')
end
...
database = '*📛¦*تم تعطيل اللعبه  ❌'
send(msg.chat_id_, msg.id_, 1,database, 1, 'md')
...
<a href="https://telegram.me/disco3">مرحبا بك في السورس الخاص في بوت ديسكو</a>
┉ ┉ ┉ ┉ ┉💠┉ ┉ ┉ ┉
...
<a href="https://telegram.me/riida">لشراء نسخة مشابهة </a>
┉ ┉ ┉ ┉ ┉💠┉ ┉ ┉ ┉
]]
send(msg.chat_id_, msg.id_, 1, text, 1, 'html')
end
...
if text and database:get(bot_id.."Del:Amr:Group"..msg.chat_id_..":"..msg.sender_user_id_) == "true" then
local NewCmmd = database:get(bot_id.."Add:amr:Group:New1"..msg.chat_id_..":"..text)
if NewCmmd then
database:del(bot_id.."Add:amr:Group:New1"..msg.chat_id_..":"..text)
database:del(bot_id.."Add:amr:Group:New"..msg.chat_id_)
database:srem(bot_id.."List:AMR:Group:New"..msg.chat_id_,text)
send(msg.chat_id_, msg.id_, 1, "تم مسح الامر من المجموعه", 1, 'html')  
else
send(msg.chat_id_, msg.id_, 1, "لا يوجد امر بهذا الاسم", 1, 'html')
end
database:del(bot_id.."Del:Amr:Group"..msg.chat_id_..":"..msg.sender_user_id_)
return false
end
local NewCmmd = database:get(bot_id.."Add:amr:Group:New1"..msg.chat_id_..":"..data.message_.content_.text_)
if NewCmmd then
...
if database:get("ridha:lock:tshake"..msg.chat_id_..bot_id) and not result.content_.text_ and not is_vip(msgg) then
...
elseif database:get("ridha:lock:tshake:kick"..msg.chat_id_..bot_id) and not result.content_.text_ and not is_vip(msgg) then
function get_edit(arg,data)
local username = data.username_
local name = data.first_name_
local iduser = data.id_
