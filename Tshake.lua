...
print(red.."\n list file \n\n\n"..reset)
print(Green.."\n powered by Ridha mohammed @riida\n "..reset)
...
if text and text == "تاك للكل" and (is_mod(msg) or is_creatorbasic(msg)) then
...
send(msg.chat_id_, msg.id_, 1, '☑️┇تم حفظ الصلاحيه بنجاح \n⚠️┇الاوامر { رفع/تنزيل '..tsha_text..' }', 1, 'md')
...
if text:match("^ايدي$") or text == ("id") and msg.reply_to_message_id_ == 0 then
local keko_info = nil
function keko333(extra,result,success)
keko_info = '@'..(result.username_ or 'لا يوجد')..''
...
🌐┇<strong>**Welcome to info Source**</strong>

┇<a href="https://telegram.me/riida">POWERD BY</a>
┇<a href="https://t.me/city5_bot">Twasil</a>
┇<a href="https://t.me/disco3">My chanle bot</a>
]]
send(msg.chat_id_, msg.id_, 1, text, 1, 'html')
end
