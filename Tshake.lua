...
if text:match("^الاوامر المضافه$") and (is_creator(msg) or is_creatorbasic(msg)) then
...
if text:match("^مسح الاوامر المضافه$") and (is_creator(msg) or is_creatorbasic(msg)) then
local list = database:smembers('tshake:'..bot_id..'tshakenwe:'..msg.chat_id_)
for k,v in pairs(list) do
