...
local list = database:smembers("tshake:edit:text:su:new:"..bot_id..msg.chat_id_)
if #list == 0 then
send(msg.chat_id_, msg.id_, 1,'🔖لا يوجد', 'html')
return false
end
t = '📝¦قائمه الاوامر المضافه\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n'
for k,v in pairs(list) do
var = database:get("tshake:edit:text:su:new2:"..v..bot_id..msg.chat_id_)
if var then
t = t..''..k..'- '..v..' » ('..var..')\n'
else
t = t..''..k..'- '..v..'\n'
...
if text == ("المنشئين") and is_malik(msg) then
local hash =   'tshake:'..bot_id..'creator:'..msg.chat_id_
...
<a href="https://telegram.me/disco3">SOURCE MONSTER</a>
┉ ┉ ┉ ┉ ┉💠┉ ┉ ┉ ┉
